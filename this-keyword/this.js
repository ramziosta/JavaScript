...
const Person = {
    ...
    fullname: () =>{ return `${Person.firstname} ${Person.lastname} yo!`},

    anotherFullName : function(){ return `${this.firstname} ${this.lastname}`},
    
    get oneMoreFullName(){return `${this.firstname} ${this.lastname} Yo G!`},
...
// Three different ways to get use in an object

console.log(Person.fullname());
console.log(Person.anotherFullName());
console.log(Person.oneMoreFullName);
