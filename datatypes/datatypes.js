...
var Person = {
   ...
   // this doesnt work,  fullname: `${this.firstname}`
// need to set up a getter function    
...
console.log(Person.sayHi(Person.obj.a));
...
//use string interpolation to use get the propeties of the objects and use their values to create sentence
objEx.innerHTML=`My name is ${Person.fullname} and my id is ${Person[id]}`;

let symEx = document.getElementById("sym-ex");
symEx.innerText = "hello Jojo";